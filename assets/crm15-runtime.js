(() => {
  ...
  loadScript('/assets/crm15-runtime-core.js?v=20260813-1', 'ymRuntimeCore')
    ...
    .then(() => loadScript('/assets/central-ym-admin.js?v=20260826-3', 'ymCentralClientAdmin'))
    .then(() => loadScript('/assets/crm15-unified-client-view.js?v=20260826-1', 'ymUnifiedClientView'))
    .then(() => loadScript('/assets/client-performance-admin.js?v=20260826-2', 'ymClientPerformanceAdmin'))
    .then(() => loadScript('/assets/client-performance-governance.js?v=20260826-2', 'ymClientPerformanceGovernance'))
